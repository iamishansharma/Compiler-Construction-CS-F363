...
int main(int argc, char *argv[])
{
	...
	if(argc!=3)
	{
		printf("Too few/many arguments, exiting! Please enter in format as \n./compiler *.txt {<- test case file} *.txt {<- file to print AST/ParseTree}\nOR\n./compiler *.txt {<- test case file} *.asm {<- machine code file}");
		exit(1);
	}
